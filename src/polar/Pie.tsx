...
import { getLabelGap, PieComputedLabel, PieSide, resolveLabelCollisionsBySide } from './pieLabelLayout';
...
function PieLabels({
  ...
  const labelCandidates: Array<PieComputedLabel<PieSectorDataItem>> = sectors
    .map((entry, index) => {
    ...
    .filter((item): item is PieComputedLabel<PieSectorDataItem> => item != null);
